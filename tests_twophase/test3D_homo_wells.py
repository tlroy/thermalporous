...
initial = "_initial_1d_Strong" + "_np" + str(n_proc)
...
case = TestCase(params, geo, well_case = None, prod_points = prod_points, inj_points = inj_points, constant_rate = True)
...
parameters = {
        ...
        #"ksp_monitor": None,
        "ksp_rtol": 1e-8,
        #"ksp_truemonitor": None,
        #"ksp_monitor_residuals": None,
...
pc_cptr5_gmres = {"pc_type": "composite",
        "pc_composite_type": "multiplicative",
        "pc_composite_pcs": "fieldsplit,bjacobi,fieldsplit",
...
pc_cprctr_gmres = {"pc_type": "composite",
        "pc_composite_type": "multiplicative",
        "pc_composite_pcs": "fieldsplit,bjacobi,fieldsplit",
        ...
        "sub_2_pc_fieldsplit_0_fields": "1",
        "sub_2_pc_fieldsplit_1_fields": "0,2",
        "sub_2_pc_fieldsplit_type": "additive",
        "sub_2_fieldsplit_0": v_cycle,    
        "sub_2_fieldsplit_1_ksp_type": "gmres",
        "sub_2_fieldsplit_1_ksp_max_it": 0,
...
pc_cprctr_gmres = {"pc_type": "composite",
        "pc_composite_type": "multiplicative",
        "pc_composite_pcs": "python,bjacobi,fieldsplit",
...
if pcname == "cprctr_gmres"     : pc = pc_cprctr_gmres
